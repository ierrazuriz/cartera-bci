...
EL_ACCIONES = [
    ("ABC", "Abc S.A.", 23_210_430, 0, 12.13),
    ("AGUAS-A", "Aguas Andinas S.A.", 1_819_069, 0, 353.7),
    ("CENCOSUD", "Cencosud S.A.", 86_229, 0, 2520.0),
    ("CHILE", "Banco De Chile", 5_000_000, 0, 170.5),
    ("COPEC", "Empresas Copec S.A.", 21_055, 0, 6508.0),
    ("ENELAM", "Enel Americas S.A.", 13_158_102, 0, 82.0),
    ("ITAUCL", "Banco Itau Chile", 3_801, 0, 19729.0),
    ("LTM", "Latam Airlines Group S.A.", 97_285_174, 0, 23.24),
]

# (nemotécnico, nombre, cantidad, precio_compra, precio_cartola)
EL_CFI = [
    ("CFIARRAA-E", "Cfiarraa-E", 4_187, 48138.424, 51702.0),
    ("CFIMRCLP", "Moneda Renta Clp Fi, Serie A", 11_172, 19592.0, 20090.52),
...
EMF_CFI = [
    ("CFIARRAA-E", "Cfiarraa-E", 500, 47154.0, 51702.0),
]
