...
Posiciones base: cartola 02/04/2026.
...
EL_ACCIONES = [
    ("ABC         ", "Abc S.A.",      23_210_430,            0,      12.1300),
    ("AGUAS-A     ", "Aguas Andinas S.A.",       1_819_069,            0,     353.7000),
    ("CENCOSUD    ", "Cencosud S.A.",          86_229,            0,    2520.0000),
    ("CHILE       ", "Banco De Chile",       5_000_000,            0,     170.5000),
    ("COPEC       ", "Empresas Copec S.A.",          21_055,            0,    6508.0000),
    ("ENELAM      ", "Enel Americas S.A.",      13_158_102,            0,      82.0000),
    ("ITAUCL      ", "Banco Itau Chile",           3_801,            0,   19729.0000),
    ("LTM         ", "Latam Airlines Group S.A.",      97_285_174,            0,      23.2400),
]

# (nemotécnico, nombre, cantidad, precio_compra, precio_cartola)
EL_CFI = [
    ("CFIARRAA-E  ", "Cfiarraa-E",    4_187,     48138.4240,     51702.0000),
    ("CFIMRCLP    ", "Moneda Renta Clp Fi, Serie A",   11_172,     19592.0000,     20090.5200),
    ("CFITRIPT-E  ", "Cfitript-E",    1_471,     13280.7610,     12000.0000),
]
...
EMF_CFI = [
    ("CFIARRAA-E  ", "Cfiarraa-E",      500,     47154.0000,     51702.0000),
]
...
# Cajas (saldo cartola 02/04/2026)
CAJA_EL       = -93_002_334
OPS_LIQUIDAR  = 52_696_129
CAJA_EMF      = 16_826_120

# Precios base (cartola 02/04/2026)
PRECIOS_DEFAULT = {
    "UF          ":     39841.7200,
    "USD         ":       915.9500,
    "EUR         ":      1062.9600,
    ...
    "AGUAS-A     ":       353.7000,
    "CENCOSUD    ":      2520.0000,
    "CFIARRAA-E  ":     51702.0000,
    "CFIMRCLP    ":     20090.5200,
    "CFITRIPT-E  ":     12000.0000,
    "CHILE       ":       170.5000,
    "COPEC       ":      6508.0000,
    "ENELAM      ":        82.0000,
    "ITAUCL      ":     19729.0000,
