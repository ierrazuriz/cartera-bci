...
EL_ACCIONES = [
    ...
    ("AGUAS-A", "Aguas Andinas S.A.",          1_380_469,  -438_600, 354.00),
    ("CENCOSUD","Cencosud S.A.",                  86_229,          0, 2_528.80),
    ("CHILE",   "Banco de Chile",             5_000_000,           0, 168.12),
    ("COPEC",   "Empresas Copec S.A.",           17_760,     -1_009, 6_400.00),
    ("ENELAM",  "Enel Americas S.A.",          2_952_382, -7_905_720,  79.30),
    ("ITAUCL",  "Banco Itau Chile",                    0,      3_801, 19_210.00),
    ("LTM",     "Latam Airlines Group S.A.", 77_217_627, -22_377_763,  22.81),
]

# (nemotécnico, nombre, cantidad, precio_compra, precio_cartola)
EL_CFI = [
        ("CFIARRAA-E", "CFI Arraa Serie E",            4_187, 48_138.4240, 52_267.0000),
]
...
EMF_CFI = [
        ("CFIARRAA-E", "CFI Arraa Serie E", 500, 47_154.0000, 52_267.0000),
]
...
# Cajas fijas (saldo cartola 01/04/2026)
CAJA_BRUTA_EL  = -856_291_313   # saldo final período
OPS_LIQUIDAR   =           0    # sin operaciones pendientes de liquidación
CAJA_EL        = -856_291_313   # = CAJA_BRUTA_EL - OPS_LIQUIDAR (caja disponible)
CAJA_EMF       =  16_826_120    # saldo caja EMF SPA (sin cambio)

# Precios base (cartola 01/04/2026) — usados como valor inicial
PRECIOS_DEFAULT = {
        "UF":          39_841.72,
        "USD":            927.46,
        "EUR":          1_071.09,
